                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: positionInstance, field: 'minimumRatings', 'errors')}">
                                    <g:select name="minimumRatings" from="${com.orangeandbronze.ozmness.MinimumRating.list()}" multiple="yes" optionKey="id" size="5" value="${positionInstance?.minimumRatings*.id}" />
                                </td>
                            </tr>
